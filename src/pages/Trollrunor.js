...
export const Trollrunor = () => {
  const [books, setBooks] = useState([])

  useEffect(() => {
    fetch("https://express-deployment-therese.herokuapp.com/series/Trollrunor")
    ...
    <Link to="/" className="button-back">
      ...
      <div className="info-part">
        <p className="info-text">
          De här böckerna tillhör alla serien Trollrunor. De handlar om Iliana, om furstesonen Ravn och om alla omkring dem.</p>
